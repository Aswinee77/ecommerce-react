            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className='py-10 flex justify-between items-center'>
                  <h1 className='text-lg opacity-60 font-bold'>Filters</h1><FilterListIcon />
                </div>
                            ...
                            <div className="space-y-4">
                              <FormControl>
                                <RadioGroup
                                  ...
                                  defaultValue="female"
                                  name="radio-buttons-group" className='pr-px-200'
                                >
              ...
              <div className="lg:col-span-4 w-full">
                <div className="flex flex-wrap justify-center py-0 bg-white">
